...
int main(void)
{
	...
	struct BigInt *res1 = init_big_int(0l);
	struct BigInt *res2 = init_big_int(0l);
	struct BigInt *res3 = init_big_int(0l);
	struct BigInt *res4 = init_big_int(0l);
	struct BigInt *res5 = init_big_int(0l);
