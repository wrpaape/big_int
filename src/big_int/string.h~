...
static inline size_t num_dec_digits(word_t num);

static inline void free_big_digits(struct BigDigits *big);

static inline word_t add_digits(digit_t digit1,
				digit_t digit2);

static inline word_t add_digit_to_word(word_t word,
				       digit_t digit);

static inline digit_t upper_digit(word_t word);

static inline digit_t lower_digit(word_t word);


static inline void add_word_to_big_digits(struct BigDigits *big,
					  word_t word);
/* HELPER FUNCTION PROTOTYPES ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲ */
