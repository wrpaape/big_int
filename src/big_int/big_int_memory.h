...
#include "big_int_globals.h"	/* shared definitions, declarations, etc... */
 ...
 * 'num_alloc'.								*
 ************************************************************************/
inline struct BigInt *init_big_int_with_words(size_t num_alloc)
{
 ...
 ************************************************************************/
inline void free_big_int(struct BigInt *big_int)
{
	free(big_int->words);
	free(big_int);
}
