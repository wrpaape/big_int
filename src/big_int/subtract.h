#ifndef BIG_INT_SUBTRACT_H_
#define BIG_INT_SUBTRACT_H_
/* EXTERNAL DEPENDENCIES ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼ */

/* #include "big_int/add.h" */
extern void add_big_ints_same_sign(struct BigInt *restrict result,
...
inline void subtract_big_ints(struct BigInt *restrict result,
			      const struct BigInt *restrict big1,
			      const struct BigInt *restrict big2)
{
...
/* EXTERNAL INLINE FUNCITON DEFINITIONS ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲ */
#endif /* ifndef BIG_INT_SUBTRACT_H_ */
